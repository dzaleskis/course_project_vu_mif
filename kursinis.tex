...
Siekiant užtikrinti šių biologinių procesų išpildymą, genetinis algoritmas vykdymo metu
...
Naujų individų generavimas yra kartojamas, kol naujos populiacijos dydis siekia $N$ (žr. \ref{simple_GA:generate_start}-\ref{simple_GA:generate_end} eil.).
...
Prieš pradedant naują ciklą (žr. \ref{simple_GA:loop_end} eil.), GA patikrina, ar kažkuri iš sustojimo sąlygų yra patenkinta, ir jei taip - baigia darbą.
...
tad atliekant sekų vertinimą, yra tikslinga įvertinti sekas naudojant ir VŠA, ir PŠA.
...
Remiantis prielaida, jog tiksliam tarpų sekų efektyvumo įvertinimui reikalinga
jas ištirti naudojant ir VŠA, ir PŠA, tai ir buvo atlikta.
...
Stebina faktas, jog naudojant VŠA gauti veikimo laikai yra 10-20\% geresni kai $N \geq 200$, nei gauti
