...
Tačiau tarkime, jog GA bus vykdomas su 100 individų populiacija skaliariniu procesoriumi su 1 GHz taktiniu dažniu kai N yra 10000.
Tada vienos kartos inversijų skaičiavimui blogiausiu atveju bus užtrunkama $\frac{10000^2 * 100}{10^9} = 10s$, kas yra visiškai nepriimtina žinant,
...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}[1]
    \Procedure{mergesort}{$a$}
      ...
      \State let $l$ and $r$ be the result of splitting $a$ at $mid$
...
\subsection{Šelo algoritmo variantų generavimas, kai N = 1000} % ar cia reikia taisyt?

\subsection{Šelo algoritmo variantų generavimas, kai N = 10000} % ar cia reikia taisyt?
